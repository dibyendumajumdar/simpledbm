...
public class Main {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            TypeDescriptor forumRowType[] = { 
            ff.getVarcharType(30), /* name */
            ...
            TypeDescriptor topicRowType[] = { 
            ff.getVarcharType(30), /* forum name */
            ...
            tableDefinition.addIndex(6, "post1.idx", new int[] { 0, 1, 2 }, true,
                    true);
            // create table
            session.createTable(tableDefinition);
            TypeDescriptor sequenceRowType[] = { 
            ff.getVarcharType(30), /* sequence name */
