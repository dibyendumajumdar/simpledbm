...
//    	
//    	IndexItemFactory getIndexItemFactory();
...
//            ithOperation.setUnique(btree.isUnique());            ithOperation.rightSibling = rootNode.header.rightSibling;
...
//            loadPageOp.pageId = setPageId(btreemgr.spMgr.getPageType(), new PageId(
//                containerId,
//                pageNumber));
