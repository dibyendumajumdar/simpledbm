...
public final class FreeSpaceManagerImpl extends BaseTransactionalModule
    ...
    public FreeSpaceManagerImpl(ObjectRegistry objectFactory,
        ...
        objectFactory.registerType(
            TYPE_ONEBITSPACEMAPPAGE,
            OneBitSpaceMapPage.class.getName());
        objectFactory.registerType(
            TYPE_TWOBITSPACEMAPPAGE,
            TwoBitSpaceMapPage.class.getName());
        objectFactory.registerType(TYPE_CREATECONTAINER, CreateContainer.class
            .getName());
        objectFactory.registerType(TYPE_OPENCONTAINER, OpenContainer.class
            .getName());
        objectFactory.registerType(
            TYPE_FORMATHEADERPAGE,
            FormatHeaderPage.class.getName());
        objectFactory.registerType(
            TYPE_FORMATSPACEMAPPAGE,
            FormatSpaceMapPage.class.getName());
        objectFactory.registerType(
            TYPE_UPDATESPACEMAPPAGE,
            UpdateSpaceMapPage.class.getName());
        objectFactory.registerType(
            TYPE_UPDATEHEADERPAGE,
            UpdateHeaderPage.class.getName());
        objectFactory.registerType(
            TYPE_UNDOUPDATEHEADERPAGE,
            UndoUpdateHeaderPage.class.getName());
        objectFactory.registerType(
            TYPE_LINKSPACEMAPPAGE,
            LinkSpaceMapPage.class.getName());
        objectFactory.registerType(
            TYPE_UNDOLINKSPACEMAPPAGE,
            UndoLinkSpaceMapPage.class.getName());
        objectFactory.registerType(TYPE_FORMATRAWPAGE, FormatRawPage.class
            .getName());
        objectFactory.registerType(
            TYPE_UNDOCREATECONTAINER,
            UndoCreateContainer.class.getName());
        objectFactory.registerType(
            TYPE_UNDOABLEUPDATESPACEMAPPAGE,
            UndoableUpdateSpaceMapPage.class.getName());
        objectFactory.registerType(
            TYPE_UNDOSPACEMAPPAGEUPDATE,
            UndoSpaceMapPageUpdate.class.getName());
        objectFactory.registerType(TYPE_DROPCONTAINER, DropContainer.class
            .getName());
    }
    ...
    public final Compensation generateCompensation(Undoable undoable) {
        ...
        log.error(LOG_CLASS_NAME, "generateCompensation", mcat.getMessage(
            "EF0003",
            undoable));
    ...
    public final void createContainer(Transaction trx, String containerName,
        ...
        if (spaceBits == 2) {
            ...
            log.error(LOG_CLASS_NAME, "createContainer", mcat.getMessage(
                "EF0001",
                spaceBits));
    ...
    public void dropContainer(Transaction trx, int containerId) {
        ...
        if (sc == null) {
            log.error(LOG_CLASS_NAME, "dropContainer", mcat.getMessage(
                "EF0002",
                containerId));
            throw new FreeSpaceManagerException(mcat.getMessage(
                "EF0002",
...
//	public static final class UndoCreateContainer extends ContainerOperation implements Compensation {
    ...
    public static abstract class SpaceMapPageImpl extends FreeSpaceMapPage {
        ...
        public final int getSpaceBits(int pageNumber) {
            ...
            log.error(LOG_CLASS_NAME, "getSpaceBits", mcat.getMessage(
                "EF0004",
                pageNumber,
                this));
            throw new FreeSpaceManagerException(mcat.getMessage(
        ...
        public final void setSpaceBits(int pageNumber, int value) {
            if (contains(pageNumber)) {
                ...
                log.error(LOG_CLASS_NAME, "setSpaceBits", mcat.getMessage(
                    "EF0004",
                    pageNumber,
                    this));
                throw new FreeSpaceManagerException(mcat.getMessage(
    ...
    public static final class SpaceCursorImpl implements FreeSpaceCursor {
        ...
        public final void fixSpaceMapPageExclusively(int spaceMapPageNumber,
                int pageNumber) {
            if (bab != null) {
                log.error(LOG_CLASS_NAME, "fixSpaceMapPageExclusively", mcat
                    .getMessage("EF0005"));
        ...
        public final FreeSpaceMapPage getCurrentSpaceMapPage() {
            if (bab == null) {
                log.error(LOG_CLASS_NAME, "getCurrentSpaceMapPage", mcat
                    .getMessage("EF0006"));
        ...
        final void doUpdateAndLogRedoOnly(Transaction trx, int pageNumber,
                int value) {
            if (bab == null) {
                log.error(LOG_CLASS_NAME, "doUpdateAndLogRedoOnly", mcat
                    .getMessage("EF0006"));
                throw new IllegalStateException(mcat.getMessage("EF0006"));
            }
        ...
        final void doUpdateAndLogUndoably(Transaction trx, int pageNumber,
                int value) {
            if (bab == null) {
                log.error(LOG_CLASS_NAME, "doUpdateAndLogUndoably", mcat
                    .getMessage("EF0006"));
                throw new IllegalStateException(mcat.getMessage("EF0006"));
            }
