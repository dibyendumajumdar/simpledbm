...
public class TestTransactionManager1 extends BaseTestCase {
	...
	public TestTransactionManager1(String arg0) {
		super(arg0);
	}
    ...
    public void testTrxLocking() throws Exception {
        ...
        try {
            ...
            try {
                ...
                trx.acquireLock(ol, LockMode.UPDATE, LockDuration.MANUAL_DURATION);
	...
	public static class BitMgrLogRedoUndo extends BaseLoggable implements LogicalUndo {
	...
	public static class OneBitMgr extends BaseTransactionalModule {
		...
		@Override
		public void undo(Transaction trx, Undoable undoable) throws BufferManagerException, TransactionException {
			
			BitMgrLogRedoUndo logrec = (BitMgrLogRedoUndo) undoable;
			
			BitMgrLogCLR clr = (BitMgrLogCLR) loggableFactory.getInstance(OneBitMgr.moduleId, TestTransactionManager1.TYPE_BITMGRLOGCLR);
			BufferAccessBlock bab = bufmgr.fixExclusive(pageId, false, TestTransactionManager1.TYPE_BITMGRPAGE, 0);
			try {
		...
		public void changeBit(Transaction trx, int index, int newValue) throws BufferManagerException, TransactionException {
			...
			BitMgrLogRedoUndo logrec = (BitMgrLogRedoUndo) loggableFactory.getInstance(OneBitMgr.moduleId, TestTransactionManager1.TYPE_BITMGRLOGREDOUNDO);
			BufferAccessBlock bab = bufmgr.fixExclusive(pageId, false, TestTransactionManager1.TYPE_BITMGRPAGE, 0);
			try {
				BitMgrPage page = (BitMgrPage) bab.getPage();
		...
		public void create(String name, int containerId, int pageNumber) throws StorageException, BufferManagerException, TransactionException, PageException {
			...
			try {
				...
				BitMgrLogOpenContainer logopen = (BitMgrLogOpenContainer) loggableFactory.getInstance(OneBitMgr.moduleId, TestTransactionManager1.TYPE_BITMGRLOGOPENCONTAINER);
				BitMgrLogFormatPage formatpage = (BitMgrLogFormatPage) loggableFactory.getInstance(OneBitMgr.moduleId, TestTransactionManager1.TYPE_BITMGRLOGFORMATPAGE);
...
//					bab1.setDirty(mylsn);
					...
					BufferAccessBlock bab = bufmgr.fixExclusive(pageId, true, TestTransactionManager1.TYPE_BITMGRPAGE, 0);
					try {
