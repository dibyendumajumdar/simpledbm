...
\section{Obtaining SimpleDBM}
\subsection{Download source code}
Download the source code for SimpleDBM from
http://www.simpledbm.org. Extract the source into a directory. This
directory will be referred to as the \verb|${simpledbm.home}|
directory in the rest of this document.

\subsection{Eclipse 3.1}
Download a binary distribution of Eclipse 3.1 from
http://www.eclipse.org. At present Eclipse is used to build
SimpleDBM, but you can also use the Netbeans IDE. Make sure that
Eclipse is setup to use J2SE 5.0 JRE, otherwise, SimpleDBM code will
not compile.

\subsection{Create project in Eclipse}
Create a Java project in Eclipse, and set the project directory to
\verb|${simpledbm.home}|. Eclipse should do the rest.
...
\hline
 \verb|org.simpledbm.common.registry| & \verb|org.simpledbm.common.registry.impl| \\
\hline
\end{tabular}
...
\hline
           Interface           &           Implementation           \\
\hline
 \verb|org.simpledbm.rss.io| & \verb|org.simpledbm.rss.io.impl| \\
\hline
\end{tabular}
...
requirement, the \verb|org.simpledbm.rss.io.StorageManager|
...
SimpleDBM provides the \verb|org.simpledbm.rss.io.Storable|
...
\hline
           Interface           &           Implementation           \\
\hline
 \verb|org.simpledbm.common.latch| & \verb|org.simpledbm.common.latch.impl| \\
\hline
\end{tabular}
...
\hline
           Interface           &           Implementation           \\
\hline
 \verb|org.simpledbm.rss.locking| & \verb|org.simpledbm.rss.locking.impl| \\
\hline
\end{tabular}
