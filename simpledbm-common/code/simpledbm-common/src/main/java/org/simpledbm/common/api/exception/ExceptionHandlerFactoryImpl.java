...
public class ExceptionHandlerFactoryImpl implements ExceptionHandlerFactory {
    ...
    public ExceptionHandlerFactoryImpl(LoggerFactory loggerFactory) {
        this.loggerFactory = loggerFactory;
    }

    public ExceptionHandler getExceptionHandler(String name) {
        return new ExceptionHandlerImpl(loggerFactory.getLogger(name));
    }
}
