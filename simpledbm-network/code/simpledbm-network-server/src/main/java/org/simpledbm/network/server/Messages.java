...
class Messages {
    ...
    static final Message noSuchTable = new Message('N', 'S', MessageType.ERROR, 2, "Table {0} does not exist");
	...
	static final Message encodingError = new Message('N', 'S', MessageType.ERROR, 7, "Unexpected error while converting message to UTF-8 format");	
	static final Message unexpectedError = new Message('N', 'S', MessageType.ERROR, 99, "Unexpected error");	
