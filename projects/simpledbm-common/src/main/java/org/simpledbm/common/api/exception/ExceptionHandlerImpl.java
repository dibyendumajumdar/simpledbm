...
/**
 * The ExceptionHandlerImpl mechanism allows the raising of exception to be handled
...
public class ExceptionHandlerImpl implements ExceptionHandler {
    ...
    /**
     * A logger is always hard wired to an instance of an ExceptionHandlerImpl
     */
    final Logger log;
